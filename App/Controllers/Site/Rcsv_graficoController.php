...
class Rcsv_graficoController extends BaseController {
    ...
    public function cadastrar(){
        ...
        if(isset($_POST['submit'])){
					...
					$historico = utf8_decode($_POST['historico_ocorrencia']);
					...
					$situacao_observada = isset($_POST['situacao_observada']) ? $_POST['situacao_observada'] : 6;
					...
					//$obs_encaminhamento = $_POST['descricao_arquivo']; 
						...
						$ano = date('Y');
						/*$num_rcsv = ocorrencia::custom('SELECT id, numero_rcsv FROM `rcsv_ocorrencia` order by id desc LIMIT 1');
						
						
						foreach($num_rcsv as $numero);
						
						$explode_num_rcsv = explode('/',$numero->numero_rcsv);
						
						
						
						
						$id_processo = $explode_num_rcsv[0];
						...
						$numero_processo = $id_processo.'/RCSV/'.$ano; */
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                          <div class="std_content00">
                                                                <h4 class="h4">COMUNICADO DE RELATO RCSV '.date("d/m/Y h:i:s").'</h4>
